...
{
    public partial class tomorrowreport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (week != "Saturday" || week != "Friday")
            {
                ...
                if (tb.Rows.Count > 0)
                {
                    ...
                    body.Append("<br/>");
                    Response.Write(body);
                    ltDll.ltClass.SendEmail("預算明天訂餐數量", "chang65101@gmail.com,weian8316@gmail.com", "Angela@elytone.com.tw", "janetxie@lightion.com", body.ToString());
                }
